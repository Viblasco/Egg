...
Algoritmo Ej11_fabricaTornillos
	...
	Si (defectuosos<200)  Y (perfectos>10000  ) Entonces
		Escribir "El empleado es grado 8";
	SiNo
		Si (defectuosos<200) Y (NO (perfectos > 10000)) Entonces
			
			Escribir "El empleado es grado 6";
		SiNo
			
			Si NO(defectuosos<200) Y  (perfectos > 10000) Entonces
				Escribir "El empleado es grado 7";
			SiNo
				Escribir "El empleado es grado 5";
			FinSi
		FinSi
